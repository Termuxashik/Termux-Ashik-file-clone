...
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1m Ashik islam

\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801300090054

\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1m Ashik Technology channel
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://https://www.facebook.com/profile.php?id=100085245083379)

		exit()

	else:

		os.system("https://https://www.facebook.com/profile.php?id=100085245083379)
...
def crack2(idf,pwv):
	...
	print('\r%s [ASHIK] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				...
				if 'ya' in oprek:
					...
					print('\r%s [ASHIK-CP] %s|%s        '%(b,idf,pw))
